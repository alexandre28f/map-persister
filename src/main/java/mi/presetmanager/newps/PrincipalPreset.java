...
public class PrincipalPreset implements IPrincipalPreset {
	...
	/** @see mi.interf.newps.IPrincipalPreset#selectDiscreteBufferForZoneAcrossAllPanels(int)
	 */
	...
	/** Called when we're converting old preset files. Assume we don't want zoning.
		...
		@see mi.interf.newps.IPrincipalPreset#setSelectedUnzonedEditStateForSecondary(int, mi.interf.IEditState)
	 */
	@Override
	...
	/** @see mi.interf.newps.IPrincipalPreset#distributeNonZoneableParams(INonZoneableCollector) */
	@Override
	...
	/** @see mi.interf.newps.IPrincipalPreset#copyFromCurrent(int) */
	@Override
