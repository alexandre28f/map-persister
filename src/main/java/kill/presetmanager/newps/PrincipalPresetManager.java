									...
									implements IPrincipalPresetManager
{
	...
	/**	@see kill.interf.newps.IPrincipalPresetManager#injectPreset(kill.interf.newps.IPrincipalPreset) */
	@Override
	...
	/** @see kill.interf.newps.IPrincipalPresetManager#switchToBufferForZone(int) */
	@Override
