...
import mi.presetmanager.newps.json.MultiState;
import mi.presetmanager.newps.json.PanelPresetState;
import mi.presetmanager.newps.json.SingleZoneState;
...
public class MultiStateZone implements IZone {
	...
	/**	Interpolate a single parameter. Deprecated: we want to generate an
		...
		@see mi.interf.newps.IZone#examineScalarMorphState(int, float)
	 */
	...
	/**	Interpolator. At a particular point, look for left and right neighbour
		...
		@see mi.interf.newps.IZone#generateMorphedState(float)
	 */
